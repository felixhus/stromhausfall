...
def bathroom_callbacks(app, button_dict):
    ...
    def menu_show(btn_additional):
        return False, True, 'bathroom'  # Show modal and close menu when button "Weitere" was clicked.
    ...
    @app.callback(Output('cyto_bathroom', 'elements'),
                  ...
                  [Input(device[1], 'n_clicks') for device in button_dict['bathroom']],
    ...
    def manage_devices_bathroom(elements, device_dict, tabs_main, children, selected_element, radio_room, radio_devices,
                                ...
                                btn_close, active_switch, btn_additional, btn_own, *btn_add):  # Callback to handle Bathroom action
        try:
            room = 'bathroom'
