...
def livingroom_callbacks(app):
    @app.callback(Output('cyto_livingroom', 'elements'),
                  ...
                  Output('menu_devices_livingroom', 'opened'),
                  ...
                  [Input(device[1], 'n_clicks') for device in dash_components.devices['livingroom']],
                  prevent_initial_call='initial_duplicate')
    def manage_devices_livingroom(elements, device_dict, tabs_main, children, selected_element, node, btn_save,
                                btn_delete,
                                btn_close, active_switch, *btn_add):  # Callback to handle livingroom action
        try:
            room = 'livingroom'
            ...
            if triggered_id is None:  # Initial call
                ...
                device_dict['rooms'][room]['name'] = 'Wohnzimmer'  # Create roomname
                device_dict['rooms'][room]['devices'] = ['lamp_' + room]  # Create list of devices in livingroom in dictionary
            ...
            if triggered_id == 'cyto_livingroom':
            ...
            elif triggered_id == 'button_close_menu_livingroom':  # The button "close" of the menu was clicked, close the menu
